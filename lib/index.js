...
var useIsInCachedRecoveredPage = function useIsInCachedRecoveredPage() {
  var _useState = React.useState(false),
      _useState2 = slicedToArray(_useState, 2),
      inCachedRecoveredPage = _useState2[0],
      setInCachedRecoveredPage = _useState2[1];

  useDidRecover(function () {
    return setInCachedRecoveredPage(true);
  });

  return inCachedRecoveredPage;
};

var useIsInActivePage = function useIsInActivePage() {
  var _useState3 = React.useState(true),
      _useState4 = slicedToArray(_useState3, 2),
      inActivePage = _useState4[0],
      setInActivePage = _useState4[1];

  React.useEffect(function () {
    return setInActivePage(true);
  }, []);
  useDidRecover(function () {
    return setInActivePage(true);
  });
  useDidCache(function () {
    return setInActivePage(false);
  });
  ...
  createClass(CacheComponent, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if (shouldUpdate) {
        ...
        var shouldSaveScrollPosition = !(willDrop || willRecover);
      ...
      return (
        ...
        React__default.createElement(
          ...
          function (props) {
            ...
            var localCacheKey = currentPathname + currentSearch;

            if (multiple && isMatchCurrentRoute) {
              var routeId = currentState && currentState.routeId;
              if (routeId) {
                localCacheKey += routeId;
              } else {
                var lastLocalCacheKey = getLastLocalCacheKey(_this2.cache);
                if (lastLocalCacheKey) {
                  localCacheKey = lastLocalCacheKey;
                }
              }

              _this2.cache[localCacheKey] = {
                updateTime: Date.now(),
            ...
            return multiple ? React__default.createElement(
              ...
              Object.entries(_this2.cache).map(function (_ref8) {
                ...
                var recomputedMatch = multipleCacheKey === localCacheKey ? match || computedMatch : null;
...
function cachedNavigation(_ref10) {
  var history = _ref10.history,
      locationObject = _ref10.locationObject,
      state = _ref10.state,
      isNew = _ref10.isNew,
      _ref10$method = _ref10.method,
      method = _ref10$method === undefined ? 'push' : _ref10$method;
  ...
  var navigationFunction = method === 'push' ? history.push : history.replace;
...
function getLastLocalCacheKey(cache) {
  ...
  var sortedCacheEntries = cacheEntries.sort(function (_ref11, _ref12) {
    var _ref14 = slicedToArray(_ref11, 2),
        prev = _ref14[1];

    var _ref13 = slicedToArray(_ref12, 2),
        next = _ref13[1];

    return prev.updateTime - next.updateTime;
  });
...
exports.cachedNavigation = cachedNavigation;
...
exports.useIsInCachedRecoveredPage = useIsInCachedRecoveredPage;
exports.useIsInActivePage = useIsInActivePage;
